...
def test_add_rating_value_1_min(client, auth_headers_admin):
...
def test_add_rating_value_5_max(client, auth_headers_admin):
...
def test_add_rating_user_success(client, auth_headers_user):
...
def test_add_rating_negative_value(client, auth_headers_user):
...
def test_add_rating_value_2(client, auth_headers_user):
...
def test_add_rating_value_3(client, auth_headers_user):
...
def test_edit_get_rating_owner_success(client, auth_headers_user):
    ...
    # Get a real rating_id from the ratings list returned by add
...
def test_edit_get_rating_no_token(client):
...
def test_edit_rating_success(client, auth_headers_user):
...
def test_edit_rating_no_token(client):
...
def test_edit_rating_out_of_range_high(client, auth_headers_user):
...
def test_edit_rating_out_of_range_low(client, auth_headers_user):
...
def test_edit_rating_invalid_rating_id(client, auth_headers_user):
