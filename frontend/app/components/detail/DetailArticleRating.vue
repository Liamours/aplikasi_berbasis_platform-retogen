...
const { article, averageRating, visibleStars, ratingSummaryLabel, ratingDraft, hoverRating, setRating } = useArticleDetail()
</script>
  ...
  <div class="content-block">
    ...
    <div class="content-block__rating-row">
      <DetailRatingStars
        ...
        @leave="hoverRating = 0"
      />
      <span v-if="ratingDraft" class="content-block__chosen-rating">{{ ratingDraft }}/5</span>
    </div>
  </div>
</template>
...
.content-block__helper { margin-top: 6px; color: var(--text-secondary); font-size: 13px; }

.content-block__score { text-align: right; }
...
.content-block__score-meta { font-size: 12px; color: var(--text-secondary); }
...
@media (max-width: 640px) {
  ...
  .content-block__header { flex-direction: column; align-items: stretch; }
  .content-block__score { text-align: left; }
}
</style>
